...
const Postjob = () => {
  return (
    <>
      <div className="max-w-[1440px] mx-auto px-4 py-6 border rounded-lg shadow-sm">
  <div className="text-center mb-4">
    <Typography fontSize="xl" className="text-center">Post New Job</Typography>
  </div>
  ...
  <div className="flex justify-end pr-9 md:pr-24 mt-4">
    ...
    <Button colorScheme="primary" className="w-24 text-white rounded-lg">Post Now
    </Button>
  </div>
</div>
    </>
